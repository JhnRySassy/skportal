...
<nav class="navbar navbar-expand-lg" style="background-color: #0f0f0f">
  <div class="container-fluid">
    <a class="navbar-brand" href="dashboard.php"><img src="../assets/SkLogo.png" style="width: 50px;"></a>
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active fs-3 fw-bold text-white " aria-current="page" href="dashboard.php">Prenza Dos Portal (ADMIN)</a>
        </li>
      </ul>
      ...
      <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-md-start fs-6">
          ...
          <li><a class="dropdown-item" href="../includes/logout.php"><i class="fa-solid fa-right-from-bracket" style="margin-left: 5px; margin-right: 10px;"></i>Log Out</a></li>
        </ul>
      </div>
    </div>
  </div>
